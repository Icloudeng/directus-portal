...
import { PartnersSubmenu } from './Partners';
import { ProductSubmenu } from './ProductSubmenu';
import { SolutionSubmenu } from './Solutions';
...
export const Navbar = () => {
    return (
        <div className='sticky top-0 h-[70px] w-full bg-white flex items-center px-10 mb-5 transition'>
                ...
                <div className='w-full flex items-center font-normal'>
                    <div className='nav__menu flex items-center flex-1'>
                        <ul className='menu-top flex items-center gap-9'>
                            ...
                            {/* <li onMouseOver={onMouseHover} onMouseOut={onMouseOut} className='relative menu-top__item dropdown hover:text-primary-400'>
                                <button type='button' className='menu-top__link flex items-center gap-1'>
                                    <span>Products</span>
                                    <VscChevronDown className="submenu-show__chevron text-primary-500 text-sm" />
                                </button>
                                <div className="submenu absolute -ml-4 mt-3 px-2 sm:px-0 top-[.7rem] invisible opacity-0">
                                    <ProductSubmenu />
                                </div>
                            </li>
                            <li className='relative menu-top__item dropdown hover:text-primary-400'>
                                <button type='button' className='menu-top__link flex items-center gap-1'>
                                    <span>Solutions</span>
                                    <VscChevronDown className="submenu-show__chevron text-primary-500 text-sm" />
                                </button>
                                <div className="submenu invisible opacity-0">
                                    <SolutionSubmenu />
                                </div>
                            </li>
                            <li className='menu-top__item hover:text-primary-400'>
                                <button type='button' className='menu-top__link flex items-center'>
                                    Pricing
                                </button>
                            </li>
                            <li className='menu-top__item hover:text-primary-400'>
                            ...
                            <li className='menu-top__item dropdown hover:text-primary-400'>
                                <button type='button' className='menu-top__link flex items-center gap-1'>
                                    Partners
                                    <VscChevronDown className="submenu-show__chevron text-primary-500 text-sm" />
                                </button>
