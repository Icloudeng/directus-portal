...
export const Navbar = () => {
    ...
    return (
        <div className={`sticky top-0 h-[70px] xl:h-[100px] flex items-center xl:px-10 mb-10 z-40 transition-all ease-in-out duration-100 ${pagePosition > 40 ?
            ...
            <div className='relative x-container-fluid flex items-center justify-between gap-4'>
                ...
                <div onClick={onMouseClick} className='nav__burger block ml-3 xl:hidden cursor-pointer'>
