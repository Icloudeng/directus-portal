...
export const BlingCard = ({
  ...
  return (
    <div
      className={`relative max-w-3xl w-full max-h-[25rem] h-[22rem] ${cardWidth} bg-white rounded-lg border border-gray-200 shadow-md`}
    >
      ...
      >
        ...
        <div className='relative p-3 flex-1 max-h-[50%] overflow-hidden m-1'>
          ...
          <p className='font-normal text-sm text-gray-200 text-ellipsis overflow-hidden p-1'>
            {text}
          </p>
        </div>
      </UnstyledLink>
