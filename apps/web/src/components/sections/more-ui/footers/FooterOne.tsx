    ...
    return (
        <footer className="sm:px-10 py-10 text-gray-300 z-0 bg-[#313b4d]">
            <div className='x-container-fluid flex flex-col gap-5 divide-y-2 divide-gray-800'>
                <div className="container px-5 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flexWrap flex-col">
                    ...
                    <div className="flex-grow flex flexWrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center order-last">
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-primary-400 trackingWidest text-sm mb-3">CATEGORIES</h2>
