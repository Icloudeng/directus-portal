                    ...
                    <div className="container px-5 mx-auto flex flex-col">
                        <div className="lg:w-4/6 mx-auto">
                            <div className="relative rounded-lg h-64 overflow-hidden">
                                ...
                                <Image alt="content" layout="fill" className="absolute object-cover object-center h-full w-full" src="https://dummyimage.com/1200x500" />
                            </div>
                            <div className="flex flex-col sm:flex-row mt-10">
                                ...
                                <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                                    ...
                                    <UnstyledLink href="#" className="text-primary-500 inline-flex items-center">Learn More
