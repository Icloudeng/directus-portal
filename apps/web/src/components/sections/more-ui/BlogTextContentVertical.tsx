    ...
    return (
        <div className='x-container max-w-7xl mx-auto py-10 flex flex-col items-center gap-10 ss:px-12'>
            <div className='flex flex-col items-center justify-center gap-7 mb-7'>
                <h1 className='text-center'>Vertical Blog Text Content</h1>
                    ...
                    <div className="container px-5 mx-auto">
                        <div className="flex flex-wrap -m-12">
                            <div className="p-12 md:w-1/2 flex flex-col items-start">
                                <span className="inline-block py-1 px-2 rounded bg-primary-50 text-primary-400 text-xs font-medium tracking-widest">CATEGORY</span>
                                ...
                                <div className="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                                    <UnstyledLink href="#" className="text-primary-400 inline-flex items-center">Learn More
                                ...
                                <UnstyledLink href="#" className="inline-flex items-center">
                                    <Image alt="blog" src="https://dummyimage.com/104x104" width={48} height={48} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
