export const SectionBoilerplate = () => {
    return (
        <div className='x-container max-w-7xl mx-auto py-10 flex flex-col items-center gap-10 ss:px-12'>
            ...
            <div className="w-full">
                <p className="text-xs text-center">
                    ...
                    Sit ipsam delectus odio ad cum dolor sint, a temporibus
                    reprehenderit amet consequuntur quisquam, facilis labore
                    beatae nihil, modi architecto harum obcaecati?
                </p>
            </div>
        </div>
    )
