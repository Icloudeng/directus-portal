...
export const BecomePartner = () => {
  return (
    <form className='max-w-3xl w-full flex flex-col gap-7 justify-center items-center mx-auto'>
      ...
      <div className='w-4/5 flex flex-wrap sm:flex-nowrap gap-7'>
        <TextArea
          inputLabel='Describe your needs'
          inputID='message'
          inputPlaceholder="Let's know your needs"
        />
      </div>
      <div className='w-4/5 flex flex-wrap sm:flex-nowrap items-center justify-between sm:mt-7 gap-3'>
        <span className='text-xs text-center sm:text-start'>
          ...
          and give your permission to create an account.
        </span>
        <Button className='w-full sm:w-auto flex items-center justify-center text-sm rounded-sm bg-primary-400 border-none px-7 py-3'>
          Submit
        </Button>
      </div>
    </form>
