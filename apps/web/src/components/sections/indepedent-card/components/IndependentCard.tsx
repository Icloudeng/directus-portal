...
export const IndependentCard = ({ itemLogo, itemName, description }:IIndependentCard) => {
  return (
    <div className="max-w-xs w-full max-h-[25rem] h-[24rem] bg-white rounded-3xl border border-gray-200 shadow-md">
      <UnstyledLink href="itemLink" className="relative w-full h-full flex flex-col items-center rounded-lg overflow-hidden">
